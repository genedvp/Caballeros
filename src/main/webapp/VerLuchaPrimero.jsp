...
<body>
    <div class="container mt-5">
        ...
        <form action="LuchaCaballeroSegundo" type="submit">
            <ul class="list-group">
                <c:forEach items="${caballeros}" var="caballero" varStatus="loop">
                    <li class="list-group-item mb-3">
                        <input class="form-check-input me-1" type="radio" name="idPrimero" value="${caballero.id}" id="Radio${loop.index}" checked>
